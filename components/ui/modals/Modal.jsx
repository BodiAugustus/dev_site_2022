...
const Modal = () => {
    ...
    return (<div className={` fixed top-0 left-0 w-full h-full bg-slate-400 bg-opacity-90 -z-10  items-center transition-all ${showModal ? 'show-modal' : null}`  }>
        <div className="flex w-[50%] sm:w-[90%] h-[50%] z-20 bg-stone-300 rounded-xl mx-auto translate-y-[50%]  opacity-100 xs:w-[80%] xs:h-[90%] xs:-mt-[70%]
        sm:h-[80%] sm:text-xl
        
         lg:-mt-40 lg:w-[70%] lg:h-[75%] xl:-mt-[16%] md:h-[50%] md:mt-0">
    

            <h3 className="text-slate-700 p-6 sm:px-4 w-full m-10 border-4 font-marcellus border-sky-900 first-letter:text-2xl indent-4 xs:text-md xl:text-3xl lg:text-2xl md:text-2xl lg:first-letter:text-5xl xl:first-letter:text-4xl sm:pt-[25%] md:pt-[15%] lg:pt-[7%] xl:pt-[14%]">I&apos;m an experienced blockchain developer with a deep understanding of Ethereum and Fantom&apos;s respective chains. <br/><br/>
