...
const Modal2 = () => {
    ...
    return (<div className={` fixed top-0 left-0 w-full h-full bg-slate-400 bg-opacity-90 -z-10  items-center transition-all ${showModal2 ? 'show-modal' : 'hide-modal'}`  }>
        <div className="flex w-[50%] h-[50%] z-20 bg-stone-300 rounded-xl mx-auto translate-y-[50%]  opacity-100 xs:w-[90%] xs:h-[70%] xs:-mt-52 lg:-mt-40 lg:w-[70%] lg:h-[75%] xl:-mt-40 md:h-[50%] md:mt-0">
            ...
            <h3 className="text-slate-700 p-6 w-full m-10 border-4 font-marcellus border-sky-900 first-letter:text-2xl indent-4 xs:text-md xl:text-3xl lg:text-2xl md:text-2xl lg:first-letter:text-5xl xl:first-letter:text-4xl ">I connect apps to the decentralized web directly through the browser by way of the web3js library and ethers package.
