...
const Footer = () => {
  const {toggleMenu} = useContext(NavbarContext)
    ...
    return (
        <footer className="flex flex-col justify-center items-center text-2xl text-white bg-sky-900 pt-6 pb-2
        xs:h-[30vh]
        lg:h-[50vh]
        xl:pt-20 ">
        ...
        <p className='bg-sky-900 md:-mt-4 text-xs
        xs:pt-10
         lg:mt-4 '>Web3 Developer -	
&#169; {time.getFullYear()} </p>
        }
        </div>
