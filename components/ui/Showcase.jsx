    ...
    <>
      {showcase.map(item => {
        ...
        return (
          <div
            key={id}
            className={`flex flex-col justify-center border-4 border-indigo-300 rounded-md bg-slate-400 items-center mt-6 mx-auto max-w-[350px]
            xxs:w-[90vw] 
            sm:w-[85vw]
            md:w-[45vw]
            lg:w-[22vw]
            ...
            2xl:h-[62vh]
            ${readMore[id] ? '2xl:h-[65vh]' : '2xl:h-[62vh]'} 
            `}
          >
