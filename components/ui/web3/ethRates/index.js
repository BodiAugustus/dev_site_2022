...
export default function EthRates({ eth, xmr, ftm, spirit, scrt, btc }) {
  return (
    <div
      className="grid grid-cols-3 mb-7 text-white mx-auto border-4 border-sky-400 p-4 bg-sky-600 rounded-xl
    ...
    >
      <div className="text-center">
        <div
          className="p-2 drop-shadow rounded-md
        "
        >
          <div
      ...
      <div className=" text-center">
        <div className="p-2drop-shadow rounded-md">
          <div
            className="flex items-center 2xl
          ml-3"
          >
            {scrt ? (
              <div className="flex">
      ...
      <div className=" text-center">
        <div className="p-2drop-shadow rounded-md">
          ...
          <p
            className="text-xl 
                    xxs:text-lg xxs:w-[70%] xxs:mx-auto 
                    lg:text-base xl:text-2xl xl:w-full"
          >
            Current BTC Price
          </p>
        </div>
