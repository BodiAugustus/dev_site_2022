...
const MobMenu = () => {
  ...
  return (
            ...
            {links.map((item, index) => {
              ...
              return (
                <NavItem
                  ...
                  title={name}
                  url={url}
                  classProps="my-0 text-lg text-white     text-3xl text-center mt-8
    ...
    sm:mt-32 sm:mb-10     "
            >
              <a
                href="https://github.com/BodiAugustus"
                target="_blank"
                rel="noreferrer"
              ...
              >
                <BsGithub
                  fontSize={40}
                  className="bg-transparent text-gray-200 hover:transition-all hover:text-slate-300 hover:scale-105 active:scale-100 cursor-pointer  "
                />
              </a>
            ...
            <div className="text-center xxs:mt-20 sm:mt-16">
              ...
              <h4 className="text-white font-thin">
                Web3 Developer & DeFi Consultant
              </h4>
            </div>
          </ul>
        </div>
      ...
      {!toggleMenu && (
        <GiAncientColumns
          fontSize={48}
          className="text-white md:hidden cursor-pointer mr-4"
