...
const WhatElse = () => {
    return(
        ...
        <h2 className="text-center mt-8 text-3xl md:text-4xl lg:text-5xl text-white font md:mb-2 lg:mt-[350px] xl:mt-[300px]  xl:mb-2">What else?</h2>
      ...
      <button    className="text-white w-[30%] md:w-[20%] lg:w-[15%] xl:w-[15%] md:text-xl xl:text-2xl pb-[9px] md:pb-[11px] xl:pb-[14px] bg-sky-600 shadow-md shadow-blue-500/75 mt-4 border-[2px] p-2 border-sky-400 rounded-full cursor-pointer font-russon transition-all hover:scale-110 active:scale-100 tracking-wide font-medium  lg:mb-6 md:border-4 ">Contact me</button>
      </div>
        </>
    )
}
