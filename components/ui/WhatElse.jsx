...
const WhatElse = () => {
    return(
        ...
        <h2 className="text-center mt-8 text-3xl md:text-4xl lg:text-5xl text-white font md:mb-2 md:-mt-[12vh] lg:mt-[20%] xl:mt-[13%] xs:-mt-[13%] sm:-mt-[15%] xl:mb-2">What else?</h2>
