       ...
       <>
           ...
           <div className="my-0 mx-auto mt-2 w-[90vw] xs:h-[80vh] max-w-[850px] sm:h-[80vh] md:h-[60vh] md:w-[75vw] lg:w-[50vw] lg:h-[100vh] xl:h-[88vh] text-center relative overflow-hidden flex border-4 rounded-xl  border-[#00bfff]">
                {blogsPost.map((blog, blogIndex) => {
                   ...
                   <div className="flex flex-col bg-[#142f43] overflow-y-scroll scrollbar-track-sky-400 font-marcellus md:mt-20 
                   xs:h-[58vh] 
                   sm:h-[60vh] 
                   md:h-[33vh] 
                   lg:h-[60vh] 
                   ...
                   lg:text-base 
                   ">
                        <h2 className='text-white font-marcellus text-xl md:text-2xl underline underline-offset-4 
                        xs:mb-3 
                        md:mb-1 
                        lg:text-xl lg:mt-4 
                        xl:text-3xl xl:mb-4 
