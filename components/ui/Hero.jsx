...
const commonStyles =
  'px-2 flex justify-center items-center border-[3px] border-sky-400 text-white bg-sky-600 hover:bg-sky-700 hover:transition-all tracking-wide xs:min-h-[90px] xs:min-w-[120px] sm:text-lg md:text-xl lg:text-base';
...
const Hero = () => {
    ...
    const resolveWithSomeData = new Promise(resolve =>
      setTimeout(
        () =>
          resolve({
            transactionHash:
              '0x525c86788b4dd762aa734c2e158081cdd78e00a0462a423b5d0262613fd3cf1b',
          }),
        4000
      )
    );
  ...
  const sendTransaction = async () => {
    try {
      if (!web3)
        return alert('You must have MetaMask installed to send payments.');
  ...
  return (
    ...
    >
      <div
        className="flex flex-col items-start justify-between py-10 px-4 
            md:p-20 md:py-8
            lg:flex-row 
            xl:pt-0 xl:p-0 xl:mr-10
            xl:w-[90%] 2xl:py-0 2xl:-mt-14"
      >
        {/* <Image
                    src="/images/test.png"
                    layout="fill"
                ...
                /> */}
        <div
          className="flex justify-start flex-col flex-1
                sm:w-full 
                md:mr-10
                "
        >
          ...
          {isLoadingWeb3 ? (
            <ButtonHero disabled={true} onClick={connect}>
              Loading...
            </ButtonHero>
          ) : account.isAdmin ? (
            <ButtonHero
        ...
        >
          <div className="lg:col-span-6">
            <h2
              className="text-2xl font-bebes text-white text-center underline underline-offset-8 mt-2 md:mb-4 
                    xxs:mb-4
                    sm:text-3xl 
                    md:text-4xl md:mt-6
          ...
          <div className="lg:col-span-6">
            <h2
              className="text-2xl font-bebes text-white text-center underline underline-offset-8 mt-2 -mb-4
                        sm:text-3xl 
            ...
            <div
              className="grid grid-cols-2 w-full mt-8 cursor-pointer
                        xxs:h-[35vh]
